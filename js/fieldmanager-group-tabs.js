...
$( document ).ready( function () {
	...
	$( ".fm-repeatable_group-wrapper .fm-repeatable_group ul.fm-tab-bar li:first-child" ).addClass( "wp-tab-active" );
	$('.fm-repeatable_group-wrapper .fm-repeatable_group .fm-group-inner div:first-child').css('display','black');
